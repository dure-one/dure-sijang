...
### Logs Analysis
```
[INFO] dure_sijang::app_metadata_renderer: [RENDER] prepare_app_info_for_display completed: 112 packages, 0 textures loaded
[INFO] dure_sijang::app_metadata_renderer: [RENDER] Metadata sources: 0 from ViewModel cache, 0 from SharedStore, 68 total metadata entries
[INFO] dure_sijang::tab_debloat::view_mobile: [DEBLOAT] Got metadata for 68 packages
[INFO] dure_sijang::dlg_mobile_list: [MOBILE_LIST] Renderer flags - GP: true, FD: true, APK: false, AP: false
```
...
sqlite3 ~/.config/dure_sijang/dbs/dure_sijang.db \
