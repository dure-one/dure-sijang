...
hero:
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/dure-one/dure-sijang
  image:
    src: /imgs/logo.png
---
...
이 사이트는 [solidbase](https://solidbase.dev/)로 제작되었으며 [solidbase-docs](https://github.com/kobaltedev/solidbase/tree/main/docs)를 기반으로 합니다
