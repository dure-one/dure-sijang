...
pub mod svg_stt;
pub mod dure_sijang_app;
pub mod dure_sijang_app_stt;
pub mod browser_stt;
...
impl Config {
    pub fn new() -> Result<Self> {
        #[cfg(target_os = "android")]
        {
            ...
            let config_dir = PathBuf::from("/data/data/app.dure.sijang/files");
            let cache_dir = PathBuf::from("/data/data/app.dure.sijang/cache");
            let download_dir = PathBuf::from("/data/data/app.dure.sijang/downloads");
            let db_dir = PathBuf::from("/data/data/app.dure.sijang/dbs");
            let tmp_dir = PathBuf::from("/data/data/app.dure.sijang/tmp");
...
/// Get application configuration (directories)
