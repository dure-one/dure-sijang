...
// LEGACY: Deleted for mycart browser - use crate::calc_stalkerware_stt::StalkerwareIndicators;
...
impl SharedStore {
    pub fn new() -> Self {
        ...
        Self {
            ...
            // LEGACY: stalkerware_indicators field removed for mycart browser
    ...
    pub fn process_updates(&self) {
        while let Some(update) = self.update_queue.pop() {
            match update {
                ...
                // LEGACY: StalkerwareIndicators removed for mycart browser
    ...
    // === Stalkerware indicators (DELETED for mycart browser) ===
    // LEGACY: Stalkerware detection not needed for browser project
    ...
    // === Scanner states (DELETED for mycart browser) ===
    // LEGACY: VirusTotal and HybridAnalysis scanners not needed for browser project
