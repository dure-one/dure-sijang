...
// On Android, calls static methods on app.dure.sijang.ShizukuBridge.
...
pub fn init_shizuku_bridge() {
    ...
    let Ok(class_name) = env.new_string("app.dure.sijang.ShizukuBridge") else {
...
#[cfg(target_os = "android")]
const BRIDGE_CLASS: &str = "pe/nikescar/dure_sijang/ShizukuBridge";
